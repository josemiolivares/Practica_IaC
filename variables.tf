...
variable "db_password" {
  ...
  type        = string
  default     = "pepepepe" # En entorno real, usar una contraseña segura y no hardcodeada
...
/* encara no tenim domini
variable "nom_domini" {
  type = string
  description = "Domini registrat en AWS"
  default = "josemiolivares.alcmarenostrum.click"
}
*/
